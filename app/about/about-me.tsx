export default function AboutMe(){
    return (
        <div key="about-me-container" className="grid grid-cols-1 gap-6 mb-6">
            <p>
                ...
                on improving client's data and their daily workflows. I work on automating and improving the quality of client's data in CRM. This attributes to higher
